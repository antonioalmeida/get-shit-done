        ...
        <div class="sidebar">
            ...
            <div class="categories">
                <?php foreach ($categoriesUser as $category) { ?>
                    <p onclick="filterListsByCategory(this)"><i style="color: #<?= $category['color'] ?>"
                                                                class="fa fa-circle"></i> <?= $category['name'] ?></p>
                <?php } ?>
            </div>
            <div>
                <br>
                ...
                <form id="addCategoryForm">
                    <div class="flex-container">
                        ...
                        <div class="color-picker" id="colorPicker">
                            ...
                            <input type="color" class="hidden" name="categoryColor" id="nativeColorPicker"
                                   value="#ff0000">
                        </div>
            ...
            <div>
                ...
                <input type="text" name="searchedTitle" placeholder="Search by title here..."
                       onkeyup="filterListsByTitle(this.value)"/>
            </div>
        </div>
            ...
            <div id="allLists" class="flex-container">
                <?php foreach ($lists as $list) { ?>
                    <div class="list" id="list<?= $list['listId'] ?>">
                        ...
                        <p><i style="color: #<?= $list['categoryColor'] ?>"
                              class="fa fa-circle"></i> <?= $list['categoryName'] ?></p>
                    </div>
                <?php } ?>
