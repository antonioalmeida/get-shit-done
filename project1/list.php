                    ...
                    <div class="item flex-container" id="item<?= $item['id'] ?>">
                        <div class="item-left">
                            ...
                            <span class="itemDescription"
                                  id="itemDescription<?= $item['id'] ?>"><?= $item['description'] ?></span>
                        </div>
                            ...
                            <form class="editItemForm">
                                <div class="flex-equal">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="editDescription" value="<?= $item['description'] ?>"
                                               required>
                                    </div>
                                    <div>
                        ...
                        <div class="item-right">
                            ...
                            <?php switch ($item['priority']) {
                                case 1: ?>
                                    <span id="item<?= $item['id'] ?>priority" onclick="updateItemPriority(this)"
                                          class="itemPriority priority-low">Low</span>
                                    <?php
                                    break;
                                case 2: ?>
                                    <span id="item<?= $item['id'] ?>priority" onclick="updateItemPriority(this)"
                                          class="itemPriority priority-medium">Med</span>
                                    <?php
                                    break;
                                case 3: ?>
                                    <span id="item<?= $item['id'] ?>priority" onclick="updateItemPriority(this)"
                                          class="itemPriority priority-high">High</span>
                                    <?php
                                    break;
                            } ?>
                            <span>
